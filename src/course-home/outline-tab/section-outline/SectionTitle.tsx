    ...
    <div className="d-flex row w-100 m-0">
      <div className="col-auto p-0">
        {complete ? (
          <Icon
            src={CheckCircle}
            className="float-left mt-1 v2-text-black-600"
            aria-hidden="true"
      ...
      <div className="col-7 ml-3 p-0 text-base font-weight-semibold v2-text-black-400">
        <span className="align-middle p-0 col-6">{title}</span>
